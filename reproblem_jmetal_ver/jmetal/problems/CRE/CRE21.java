...
//
// This is the two-objective two bar truss design problem with three constraints
// 
// Reference:
...
public class CRE21 extends Problem {
 ...
 /**
  * Constructor.
  * Creates a default instance of the CRE21 problem.
  */
  public CRE21() {
  ...
  public void evaluateConstraints(Solution solution) throws JMException {
    ...
    for (int i = 0; i < numberOfObjectives_; i++) f[i] = solution.getObjective(i);
